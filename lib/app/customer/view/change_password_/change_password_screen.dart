...
class ChangePasswordCustomerScreen
    extends GetView<ChangePasswordCustomerController> {
  ChangePasswordCustomerScreen({super.key});
  @override
  var controller = Get.put(ChangePasswordCustomerController());

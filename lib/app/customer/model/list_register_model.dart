class ListRegisterForCustomerModel {
  int? maPhieuvao;
  TaixeRe? taixeRe;
  LoaixeRe? loaixeRe;
  String? giovao;
  ...
  ListRegisterForCustomerModel.fromJson(Map<String, dynamic> json) {
...
class DockRe {
  ...
  DockRe({this.tenDock, this.maCua, this.status, this.maDock});

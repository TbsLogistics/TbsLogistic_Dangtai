import 'package:tbs_logistics_dangtai/app/customer/model/list_register_model.dart';

class ListRegistedOfCustomer {
  int? maPhieuvao;
  TaixeRe? taixeRe;
  LoaixeRe? loaixeRe;
  String? giovao;
  ...
  ListRegistedOfCustomer.fromJson(Map<String, dynamic> json) {
...
class Statustracking {
  ...
  Statustracking({this.lv, this.matrangthai, this.name});

...
class ChangePasswordTallymanScreen
    extends GetView<ChangePasswordTallymanController> {
  ChangePasswordTallymanScreen({super.key});
  @override
  var controller = Get.put(ChangePasswordTallymanController());
